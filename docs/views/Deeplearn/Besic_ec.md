...
还有一个新的激活函数叫做**Swish**。这个**Swish**激活函数长什么样子，它是一个非常神奇的激活函数，他把**sigmoid**乘上![z](https://math.jianshu.com/math?formula=z)得到她的output。
...
# 3 损失函数（cost fun）/损失函数 （loss func）
